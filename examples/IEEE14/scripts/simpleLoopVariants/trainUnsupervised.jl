...
function trainModelUnsupervised(model, optimizer, train_in, test_in, train_in_transform, test_in_transform, train_out_transform,  test_out_transform; train_out=nothing, test_out=nothing, epochs=100)
